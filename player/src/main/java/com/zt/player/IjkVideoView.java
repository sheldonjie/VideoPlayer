...
/**
 * Created by zhouteng on 2017/7/28.
 */

public abstract class IjkVideoView extends FrameLayout {
    ...
    public IjkVideoView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
    ...
    private void initView(Context context) {
        ...
        surfaceContainer = (ViewGroup) findViewById(getSurfaceContainerId());
    }
...
//                subtitleDisplay.setText(text.getText());
    ...
    protected abstract void setBufferProgress(int progress);
